...
def main():
    ...
    # Load image model
    model_dir = "/vol/biomedic3/rrr2417/cxr-generation/src/models/diffae/output/mnist_sem_it2"  # 500
    # model_dir = "/vol/biomedic3/rrr2417/cxr-generation/src/models/diffae/output/mnist_sem_it"  # 500
    # model_dir = "/vol/biomedic3/rrr2417/cxr-generation/src/models/diffae/output/mnist_cond_it"  # 200
    # model_dir = "/vol/biomedic3/rrr2417/cxr-generation/src/models/diffae/output/mnist_cond_it_0.5"  # 200
    print(model_dir)
    model = DiffusionAutoEncodersInterface({'output': model_dir, 'model_ckpt': 'epoch_200_ckpt.pth'}, 'test')
    _ = model.model.eval()
    ...
    # Calculate metrics
    for feat, dl_test in [("thickness", dl_test_t), ("intensity", dl_test_i)]:  # "slant", "class"]: # features_order:
